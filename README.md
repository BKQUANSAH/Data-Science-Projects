...
Project 1 focuses on the use of python to perform data analysis to find answers to questions that will help a Foodhub to improve its business.
...
Project 3 is a machine learning problem with focus on supervised learning (Regression). A Machine Learning-based solution is used to develop a dynamic pricing strategy for used and refurbished devices for ReCell.
...
Project 5 is on the use of Ensemble Techniques to analyze the data provided by Easy Visa and, with the help of a classification model: 1. Facilitate the process of visa approvals, and 2. recommend a suitable profile for the applicants for whom the visa should be certified or denied based on the drivers that significantly influence the case status.
...
The MIT/IDSS project is on Customer Personality using K-Means and Hierarchical clustering. [Massachusetts Institute of Technology: Data Science and Machine Learning]
